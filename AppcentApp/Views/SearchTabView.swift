...
struct SearchTabView: View {
    ...
    private var overlayView: some View {
        ...
        case .empty:
            if !searchVM.searchQuery.isEmpty {
                ...
                EmptyPlaceholderView(text: "Click the search bar for news", image: Image(systemName: "magnifyingglass"))
            }
    ...
    private var suggestionsView: some View {
        ForEach(["Besiktas", "Corona Virus", "Turkey", "Appcent"], id: \.self) { text in
            Button {
